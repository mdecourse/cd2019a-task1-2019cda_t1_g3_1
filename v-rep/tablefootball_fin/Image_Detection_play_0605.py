...
if clientID!=-1:
  ...
  while (vrep.simxGetConnectionId(clientID) != -1):
    ...
    blue00_pos=blue10_pos=blue11_pos=blue20_pos=blue21_pos=blue22_pos=blue23_pos=blue24_pos=blue30_pos=blue31_pos=blue32_pos=None
    red00_pos=red10_pos=red11_pos=red20_pos=red21_pos=red22_pos=red23_pos=red24_pos=red30_pos=red31_pos=red32_pos=None
    ...
    if err == vrep.simx_return_ok:
        ...
        if ret_green != None:
            ...
            for i in range(len(ret_blue)):
                if ret_blue[i][1] >=200 and ret_blue[i][1] <=220:
                    blue00 = (ret_blue[i][0], ret_blue[i][1])
                elif ret_blue[i][1] >= 180 and ret_blue[i][1] <=200:
                    blue10_pos = (ret_blue[i][0], ret_blue[i][1])
                    if blue11_pos== None:
                        blue11_pos= (ret_blue[i][0], ret_blue[i][1])
                elif ret_blue[i][1] >=130 and ret_blue[i][1] <=150:
                    if blue20_pos == None:
                        if blue24_pos == None:
                            blue24_pos = (ret_blue[i][0], ret_blue[i][1])
                        elif blue23_pos == None:
                            blue23_pos = (ret_blue[i][0], ret_blue[i][1])
                        elif blue22_pos == None:
                ...
                elif ret_blue[i][1] >=80 and ret_blue[i][1] <=100:
                    if blue30_pos == None:
                        if blue32_pos == None:
            ...
            for i in range(len(ret_red)):
                if ret_red[i][1] >=30 and ret_red[i][1] <=50:
                    red00 = (ret_red[i][0], ret_red[i][1])
                elif ret_red[i][1] >= 55 and ret_red[i][1] <=75:
                    red10_pos = (ret_red[i][0], ret_red[i][1])
                    if red11_pos == None:
                        red11_pos = (ret_red[i][0], ret_red[i][1])
                elif ret_red[i][1] >=105 and ret_red[i][1] <=125:
                    if red20_pos == None:
                        if red24_pos == None:
                            red24_pos = (ret_red[i][0], ret_red[i][1])
                        elif red23_pos == None:
                            red23_pos = (ret_red[i][0], ret_red[i][1])
                        elif red22_pos == None:
                ...
                elif ret_red[i][1] >=153 and ret_red[i][1] <=173:
                    if red30_pos == None:
                        if red32_pos == None:
    ...
    #------------------------------對打程式開始------------------------------
        ...
        if ret_blue:
            for i in range(len(ret_blue)):
                cv2.rectangle(img2,(int(ret_blue[i][0] - 5),int(ret_blue[i][1] - 5)), (int(ret_blue[i][0] + 3),int(ret_blue[i][1] + 5)), (0x33,0xcc,0xff), 1)
        if ret_red:
            for i in range(len(ret_red)):
                cv2.rectangle(img2,(int(ret_red[i][0] - 5),int(ret_red[i][1] - 5)), (int(ret_red[i][0] + 3),int(ret_red[i][1] + 5)), (0xff,0x33,0x33), 1)
        if ret_green:
